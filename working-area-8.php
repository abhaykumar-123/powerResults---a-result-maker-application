    ...
    <div class="container" style="overflow:hidden;">
     ...
     <tr>
      ...
      <th  colspan="8" style="border-left-style:none;border-right-style:none;"><?php echo "$examtype"; ?></th>
	   <th  colspan="6" style="border-left-style:none;"></th>
    </tr>
     ...
     <tr>
      ...
      <th   colspan="6" style="border-left-style:none;">Session : <?php echo "$year"; ?> </th>
    </tr>
  ...
  $("#add").click(function(){
	  ...
	  var rn = $('#rn').val();
		...
		var a = parseFloat($('#sb1').val()),
			...
			if(sb1 === '' || sb2 === '' || sb3 === '' || sb4 === '' || sb5 === '' || sb6 === '' || sb7 === '' || sb8 === '' ||
    ...
    "<td>"+(((a+b+c+d+e+f+g+h)/tmm)*per).toFixed(2)+"</td></tr>"
