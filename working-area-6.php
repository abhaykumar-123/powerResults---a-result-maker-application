    ...
    <div class="container" style="overflow:hidden;">
     ...
     <tr>
      ...
      <th  colspan="8" style="border-left-style:none;border-right-style:none;"><?php echo "$examtype"; ?></th>
	   <th  colspan="4" style="border-left-style:none;"></th>
    </tr>
     ...
     <tr>
      ...
      <th   colspan="4" style="border-left-style:none;">Session : <?php echo "$year"; ?> </th>
    </tr>
...
$(document).ready(function(){
  $("#add").click(function(){
    ...
    "<td>"+sb6+"</td>"+
    "<td>"+(a+b+c+d+e+f)+"</td>"+
    "<td>"+(((a+b+c+d+e+f)/tmm)*per).toFixed(2)+"</td></tr>"
