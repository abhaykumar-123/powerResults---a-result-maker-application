    ...
    <div class="container" style="overflow:hidden;">
     ...
     <tr>
      ...
      <th  colspan="8" style="border-left-style:none;border-right-style:none;"><?php echo "$examtype"; ?></th>
	   <th  colspan="5" style="border-left-style:none;"></th>
    </tr>
     ...
     <tr>
      ...
      <th   colspan="5" style="border-left-style:none;">Session : <?php echo "$year"; ?> </th>
    </tr>
...
$(document).ready(function(){
  $("#add").click(function(){
    ...
    "<td>"+sb7+"</td>"+
    "<td>"+(a+b+c+d+e+f+g)+"</td>"+
    "<td>"+(((a+b+c+d+e+f+g)/tmm)*per).toFixed(2)+"</td></tr>"
...
html2pdf().set(opt).from(element).save();
	...
	<script>
      function op() {
          ...
          var panel = document.getElementById("record");//put your table inside a panel.
